...
public class RegistProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 나이 입력 이벤트 등록
        TextView textViewAge = (TextView)findViewById(R.id.profile_editText_age);
        ...
        // 키 입력 이벤트 등록
        TextView textViewHeight = (TextView)findViewById(R.id.profile_editText_height);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.profile_next_step_button:
                try {
                    ...
                    Log.d(RegistProfileActivity.class.getName(), "Save user profile data has been failed.");
                }
                return;
        ...
        switch (view.getId()) {
            // 성별 선택 이벤트 처리
            case R.id.profile_button_gender_male: onGenderButtonClick(Gender.MAN); break;
            case R.id.profile_button_gender_female: onGenderButtonClick(Gender.WOMAN); break;
        ...
        if (m_currentStep >= m_lastStep) {
            ...
            profileBO.updateProfile(profile).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    ...
                    Intent intent = new Intent(RegistProfileActivity.this, MainPagerActivity_.class);
    ...
    private void onProfileDataChanged() {
        ...
        final Pair<Boolean, String> validateResult = ValidateNextStep();
        ImageButton goToNextStepButton = (ImageButton)findViewById(R.id.profile_next_step_button);
        goToNextStepButton.setEnabled(validateResult.getFirst());
    }
    ...
    private Pair<Boolean, String> ValidateNextStep() {
        ...
        */
        ...
        if (m_currentStep == 0) {
            // 이름 유효성 검사
            final TextView inputName = (TextView)findViewById(R.id.profile_editText_name);
            ...
            // 닉네임 유효성 검사
            final TextView inputNickName = (TextView)findViewById(R.id.profile_editText_nickname);
    ...
    private DatePickerDialog openDatePicker() {
        return new DatePickerDialog(RegistProfileActivity.this, android.R.style.Theme_Holo_Light_Dialog, dateSetListener,
                DatePickerDefaultYear, DatePickerDefaultMonth, DatePickerDefaultDay);
    }

    private void openNumberPickerAge() {
        final NumberPicker numberPicker = new NumberPicker(RegistProfileActivity.this);
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(RegistProfileActivity.this).setView(numberPicker);
